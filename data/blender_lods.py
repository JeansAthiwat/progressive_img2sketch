...
base_path = "/ssd/du_dataset/mvdfusion/LOD_dataset"
...
processed_base_path = "/ssd/du_dataset/mvdfusion/LOD_dataset_imgs"
...
def setup_lighting():
    ...
    for loc in light_locations:
        ...
        light.data.energy = 3000.0  # Increase light energy to ensure the scene is well-lit
...
def render_views(output_folder, model_name):
    ...
    if objs:
        ...
        distance_factor = 2.0  # Adjust this factor to control how much space is around the object
    ...
    elevation_angle = math.radians(90)   # Set elevation angle to 90 degrees for top-down view
        ...
        if os.path.isdir(folder_path):
            for lod in range(1, 5):
                ...
                if os.path.exists(obj_file_path):
                    ...
                    setup_lighting()
                    output_folder = os.path.join(processed_base_path, folder, f"lod{lod}")
