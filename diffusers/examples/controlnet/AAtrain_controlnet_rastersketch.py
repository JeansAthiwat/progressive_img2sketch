...
def log_validation(
    ...
    for validation_prompt, validation_image in zip(validation_prompts, validation_images):
        image_name = os.path.splitext(os.path.basename(validation_image))[0]
        print("Validating:", image_name)
        ...
        for _ in range(args.num_validation_images):
            ...
            save_path = os.path.join(args.output_dir, "validation", f"{image_name}_step_{step}_{_}.png")
...
def parse_args(input_args=None):
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help="Custom name for this wandb run.",
    )
...
""" lod2 to 1 controlnet
  accelerate launch /home/athiwat/progressive_img2sketch/diffusers/examples/controlnet/AAtrain_controlnet_rastersketch.py \
  --pretrained_model_name_or_path="stable-diffusion-v1-5/stable-diffusion-v1-5" \
  --output_dir="/mnt/nas/athiwat/ControlNet_models/29-07-2025-lod2to1-laplacian_of_gradient_1rad_dataset" \
  --train_data_dir="/home/athiwat/progressive_img2sketch/resources/LOD50_opaque_normalized_1radius_triangulated_fix_normals_orbits_with_depth_cropped_512x512/log" \
  ...
  --validation_image "/home/athiwat/progressive_img2sketch/resources/LOD50_opaque_normalized_1radius_triangulated_fix_normals_orbits_with_depth_cropped_512x512/log/36/lod2/lod2_az000_el30.png" "/home/athiwat/progressive_img2sketch/resources/LOD50_opaque_normalized_1radius_triangulated_fix_normals_orbits_with_depth_cropped_512x512/log/49/lod2/lod2_az070_el40.png" \
  ...
  --tracker_run_name="29-07-2025-lod2to1-laplacian_of_gradient_1rad_dataset" \
  --report_to=wandb \
  """