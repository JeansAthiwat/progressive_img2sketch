...
from dataset_builder import BuildingSketchDataset
...
# Dataset loading functions removed - using BuildingSketchDataset directly
...
def main(args):
    ...
    # Use BuildingSketchDataset instead of HuggingFace dataset
...
""" lod 2 to 1
  ...
  --output_dir="/mnt/nas/athiwat/ControlNet_models/22-07-2025-lod2to1-stable-diffusion-xl" \
  ...
  --validation_prompt "minimalist architectural line‑art, svg‑style, isometric view, crisp black strokes, pure white background, no colours, no shading, no gradients" "minimalist architectural line‑art, svg‑style, isometric view, crisp black strokes, 1‑pixel width, pure white background, no colours, no shading, no gradients" \
  --num_validation_images=2 \
  --seed=42 \
  --tracker_run_name="22-07-2025-lod2to1-stable-diffusion-xl_b16_gradaccum1_ep12_controlnet" \
  --report_to=wandb \
"""